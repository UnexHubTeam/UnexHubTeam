...
<!-- DOCS-NAV:START -->
[English (primary)](../en/claude-code-install.md) · [中文目录](README.md) · [公开 API 文档 ↗](https://documenter.getpostman.com/view/57297668/2sBYArUsxK) · [Agent 开发中心 ↗](https://unexhub.ai/agent-doc)
...
1. [1）准备环境](#section-1)
2. [2）安装 Claude Code](#section-2)
3. [3）配置 API 地址、Key 和模型](#section-3)
4. [4）验证首次对话](#section-4)
5. [5）保存配置，供下次使用](#section-5)
6. [6）查看计费](#section-6)
7. [参考资料](#section-7)
</details>
<!-- DOCS-TOC:END -->
...
[← 上一篇：Aider](aider.md) · [中文目录](README.md) · [下一篇：Claude Code →](claude-code.md)
<!-- DOCS-PAGER:END -->
