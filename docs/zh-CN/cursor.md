...
[English (primary)](../en/cursor.md) · [中文目录](README.md) · 简体中文（辅助翻译）
...
在 OpenAI 配置区域查找 **Override OpenAI Base URL** 或同义的自定义地址选项。Polo 教程使用这一入口；当前官方 BYOK 说明确认支持 API Key，但未在该说明页明确保证任意自定义 Base URL。
