...
1. [1）创建第三方路由 Key](#section-1)
2. [2）选择可用模型](#section-2)
3. [3）填写接入信息](#section-3)
4. [4）发起调用](#section-4)
5. [5）查看第三方调用与扣费](#section-5)
</details>
<!-- DOCS-TOC:END -->
...
[← 上一篇：聊天补全 API](chat-completions.md) · [中文目录](README.md) · [下一篇：计费记录 →](billing.md)
<!-- DOCS-PAGER:END -->
