...
<!-- DOCS-NAV:START -->
[English (primary)](../en/windsurf.md) · [中文目录](README.md) · [公开 API 文档 ↗](https://documenter.getpostman.com/view/57297668/2sBYArUsxK) · [Agent 开发中心 ↗](https://unexhub.ai/agent-doc)
...
1. [1）安装并打开编辑器](#section-1)
2. [2）判断是否提供自定义网关](#section-2)
3. [3）使用集成终端接入 UNEXHub](#section-3)
4. [4）验证对话并查看费用](#section-4)
5. [参考资料](#section-5)
</details>
<!-- DOCS-TOC:END -->
...
> 核对时，Windsurf 的模型文档重定向到 Devin Desktop 文档，未确认任意 UNEXHub Base URL 的原生配置入口。不要假定通用 OpenAI 设置或环境变量适用于所有当前版本。
...
[← 上一篇：Cursor](cursor.md) · [中文目录](README.md) · [下一篇：Aider →](aider.md)
<!-- DOCS-PAGER:END -->
